...
/**Объект для тестирования столкновений*/
public class OverlapTester {
	
	/*Проверка соприкосновения двух окружностей*/	
	...
	/**Проверка столкновения круга и треугольника*/
	...
	/**Проверка столкновений точи и вектора*/
	public static boolean pointInCircle(Circle c, Vector2 p) {
		return c.center.distSquared(p) < c.radius * c.radius;
	}
	/**Проверка столкновений точки и круга*/
	public static boolean pointInCircle(Circle c, float x, float y) {
		return c.center.distSquared(x, y) < c.radius * c.radius;
	}
	/**Проверка столкновений Прямоугольника и вектора*/
	public static boolean pointInRectangle(Rectangle r, Vector2 p) {
		return r.lowerLeft.x <= p.x && r.lowerLeft.x + r.width >= p.x &&
		r.lowerLeft.y <= p.y && r.lowerLeft.y + r.height >= p.y;
	}
	/**Проверка столкновений Прямоугольника и точки*/
	...
	/**Проверка столкновений вектора3D и шара*/
	public static boolean pointInSphere(Sphere c, Vector3 p) {
		return c.center.distSquared(p) < c.radius * c.radius;
	}
	
	/**Проверка столкновения Шара с точкой в 3D*/

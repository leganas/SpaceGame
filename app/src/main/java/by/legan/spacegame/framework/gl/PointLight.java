...
public class PointLight {
	...
	/**Задает Ambient составляющую источника света*/
	...
	/**Задает местоположение источника света в пространстве 3D*/
	...
	/**(Включает) Регистрирует источник света в системе OpenGL*/
	...
	/**Выключает последний включенный источник света*/

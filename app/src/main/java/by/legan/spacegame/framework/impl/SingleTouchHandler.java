...
/**реализацию интерфейса TouchHandler для Android версий 1.5 и 1.6
 * подходит только для обработки одиночных касаний*/
public class SingleTouchHandler implements TouchHandler {
	...
	public boolean isTouchDown(int pointer) {
		synchronized(this) {
			if(pointer == 0) return isTouched; else return false;
		}
	}
	@Override

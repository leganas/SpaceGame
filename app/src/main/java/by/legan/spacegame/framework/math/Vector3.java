...
/**Класс для работы с векторами в 3D
 * всё аналогично vector2 только добавляется z координата*/
public class Vector3 {
	...
	public Vector3 add(float x, float y, float z) {
		...
		/**Вращение вектора относительно осей, хуй знет как :) при помощи каких то матриц*/
		...
		public float dist(Vector3 other) {
			...
			return (float)Math.sqrt(distX * distX + distY * distY + distZ *
			distZ);
		}

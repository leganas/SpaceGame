...
/**Для обработки мультитач используем класс MultiTouchHandler*/
...
/**обрабатываем несколько указателей и устанавливаем для элемента TouchEvent.pointer соответствующее значение*/
	@Override

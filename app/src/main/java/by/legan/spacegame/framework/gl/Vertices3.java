...
/**Класс для работы с вершинами в 3D
 * подробное описание страница 525*/
public class Vertices3 {
	 ...
	 * привязывает массив наших треугольников со всеми параметрами к системе OpenGL ES*/
	public void bind() {
	...
	/**Вызывается после окончания использования draw, и перед использованием другого экземпляра класса Virtices3*/
	public void unbind() {
		GL10 gl = glGraphics.getGL();
		if (hasTexCoords)
